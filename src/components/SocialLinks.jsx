...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/muhammad-riskan-rajabi-271a08392",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@rizqan_rajabi",
    icon: Instagram,
    url: "https://www.instagram.com/rizqan_rajabi?igsh=dG02ZW10NmRnZGZt",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@RizkanRajabi",
    icon: Youtube,
    url: "https://www.youtube.com/@RizkanRajabi",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@pejabatjujur_",
    color: "black",
...
const SocialLinks = () => {
  ...
  return (
    <div id="ConnectWithMe" className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
