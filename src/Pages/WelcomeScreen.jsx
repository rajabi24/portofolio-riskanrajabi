...
const BackgroundEffect = () => (
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-r from-[#1d4ed8]/20 to-[#0ea5e9]/20 blur-3xl animate-pulse" />
    <div className="absolute inset-0 bg-gradient-to-tr from-[#1d4ed8]/10 via-transparent to-[#0ea5e9]/10 blur-2xl animate-float" />
  </div>
);

const IconButton = ({ Icon }) => (
  <div className="relative group hover:scale-110 transition-transform duration-300">
    <div className="absolute -inset-2 bg-gradient-to-r from-[#1d4ed8] to-[#0ea5e9] rounded-full blur opacity-30 group-hover:opacity-75 transition duration-300" />
...
const WelcomeScreen = ({ onLoadingComplete }) => {
  ...
  return (
    <AnimatePresence>
      {isLoading && (
        <motion.div
          className="fixed inset-0 bg-[#020d1a]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit="exit"
        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                {[Camera, Github, User].map((Icon, index) => (
