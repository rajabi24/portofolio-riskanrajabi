...
export default function Dashboard() {
  ...
  return (
    <div className="flex text-white" style={{ height: '100dvh' }}>
      ...
      <aside className="hidden lg:flex w-60 shrink-0 flex-col border-r border-white/8 bg-white/3 backdrop-blur-xl"
        style={{ height: '100dvh', position: 'sticky', top: 0 }}>
        <SidebarContent />
      </aside>

      <aside className={`fixed inset-y-0 left-0 z-30 w-60 flex flex-col border-r border-white/8 bg-[#0a0a1a] backdrop-blur-xl transition-transform duration-300 lg:hidden ${
