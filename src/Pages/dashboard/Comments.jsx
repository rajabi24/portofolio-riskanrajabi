...
const Card = ({ children, className = "" }) => (
  <div className={`relative group ${className}`}>
    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#1d4ed8] to-[#0ea5e9] rounded-2xl blur opacity-10 group-hover:opacity-20 transition duration-500 pointer-events-none" />
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start sm:items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[#1d4ed8] to-[#0ea5e9] rounded-xl blur opacity-50 pointer-events-none" />
          ...
          {[
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 sm:px-4 py-1.5 rounded-lg text-xs sm:text-sm transition-all duration-200 ${
                filter === tab.value
                  ? "bg-gradient-to-r from-blue-500/25 to-sky-500/20 border border-blue-500/35 text-white font-medium"
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          { label: "Pinned", value: pinnedCount, color: "text-sky-400" },
          {
            label: "Unpinned",
        ...
        <div className="space-y-2.5">
          {paginated.map((comment) => (
            <div key={comment.id} className="relative group">
              {comment.is_pinned && (
                <div className="absolute -inset-0.5 bg-gradient-to-r from-[#1d4ed8] to-[#0ea5e9] rounded-2xl blur opacity-15 pointer-events-none" />
              )}
              <div
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  {/* Avatar */}
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-blue-500/20 to-sky-500/20 border border-white/10 flex items-center justify-center shrink-0">
                    <img
